...
💡 Tip: You can find these values in your Slack app dashboard under Basic Information and OAuth & Permissions. Guidance on how to retrieve these values are found here.
